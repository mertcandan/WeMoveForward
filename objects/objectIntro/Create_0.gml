...
introtext[0] = "......";
introtext[1] = "In difficult times, people have a tendency to get stuck,\nto wallow or be so ruined that they can’t even fathom getting up and carrying on.";
introtext[2] = "To truly grow and develop as a person,\nto move past your hurdles and conquer your traumas,\nyou must move forward.";
introtext[3] = "This can be facing your issues head on\nor it can be silently letting them slip away into history,\nshedding an unseen weight.";
introtext[3] = "It’s slaying the metaphorical dragon besieging your mind,\ntaking back the castle, and saving the princess."
introtext[4] = "It only makes sense to call this “We Move Forward,”\na game focused on the growth and development of a girl stuck in place.";
